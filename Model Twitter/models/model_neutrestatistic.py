...
class model_neutrestatistic(osv.osv):
    _name="twitter.neutrestatistic"
    _columns={
    ...
    def create(self, cr, uid, values, context=None):
        ...
        out=super(model_neutrestatistic, self).create(cr, uid, data, context=context)
        out=super(model_neutrestatistic, self).create(cr, uid, data2, context=context)
        out=super(model_neutrestatistic, self).create(cr, uid, data3, context=context)
        out=super(model_neutrestatistic, self).create(cr, uid, data4, context=context)
        return out
model_neutrestatistic()